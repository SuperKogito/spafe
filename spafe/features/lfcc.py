...
def lfcc(signal, num_ceps, ceplifter=22):
    """
    ...
    raw_lfccs         = dct(log_features, type=2, axis=1, norm='ortho')[:,:num_ceps]      
    
    # filter and normalize
    lfccs = proc.lifter(raw_lfccs, ceplifter)
    lfccs = cepstral.cmvn(cepstral.cms(lfccs))
    return lfccs
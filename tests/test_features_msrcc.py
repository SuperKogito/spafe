...
def test_msrcc(sig, fs, num_ceps, nfilts, nfft, low_freq, high_freq, dct_type,
    ...
    if use_energy:
        ...
        np.testing.assert_almost_equal(msrccs_energy, gfccs_energy, 3)

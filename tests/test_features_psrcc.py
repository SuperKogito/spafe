...
def test_psrcc(
    ...
    if use_energy:
        ...
        np.testing.assert_array_almost_equal(psrccs_energy, xfccs_energy, 3)
    ...
    np.testing.assert_array_almost_equal(psrccs, predifined_fbanks_feats, 3)

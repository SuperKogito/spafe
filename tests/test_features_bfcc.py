...
def test_bfcc(sig, fs, num_ceps, nfilts, nfft, low_freq, high_freq, dct_type,
    ...
    if use_energy:
        ...
        np.testing.assert_almost_equal(bfccs_energy, gfccs_energy, 3)
